...
var Main = /*#__PURE__*/function () {
  ...
  _createClass(Main, [{
    ...
    value: function bindEvents() {
      new _productCreateValidate__WEBPACK_IMPORTED_MODULE_0__["default"]();
    }
  }]);
...
var productCreateValidate = /*#__PURE__*/function () {
  ...
  _createClass(productCreateValidate, [{
    ...
    value: function bindEvents() {
      ...
      var form = document.getElementById('product-create');
      form.addEventListener('submit', function (e) {
        e.preventDefault();
        var alerts = form.querySelectorAll('.alert-err');

        _this.removeAlerts(alerts);
        ...
        (image === null || image === void 0 ? void 0 : image.value) === '' ? _this.checkValid('Добавьте изображение товара', image) : '';
        (name === null || name === void 0 ? void 0 : name.value) === '' ? _this.checkValid('Поле не может быть пустым', name) : '';
        (content === null || content === void 0 ? void 0 : content.value) === '' ? _this.checkValid('Поле не может быть пустым', content) : '';
        (price === null || price === void 0 ? void 0 : price.value) === '' ? _this.checkValid('Поле не может быть пустым', price) : '';
        (category === null || category === void 0 ? void 0 : category.value) === '0' ? _this.checkValid('Поле не может быть пустым', category) : '';
      });
    }
  }, {
    key: "alertError",
    value: function alertError(cont) {
      var alert = "\n        <div class=\"alert alert-danger alert-err\">\n            ".concat(cont, "\n        </div>\n        ");
      return alert;
    }
  }, {
    key: "checkValid",
    value: function checkValid(cont, input) {
      input.insertAdjacentHTML('afterEnd', this.alertError(cont));
    }
  }, {
    key: "removeAlerts",
    value: function removeAlerts(alerts) {
